...
antlr :
	...
	(cd ${ROOT_DIR}/src/main/antlr4;  java -jar ${ROOT_DIR}/antlr-4.${ANTLR_VERSION}-complete.jar -o ${ROOT_DIR}/src/main/java -visitor -package org.commonwl.cwl.ecma.v1_2 CwlParameterReferenceLexer.g4 CwlParameterReferenceParser.g4)
